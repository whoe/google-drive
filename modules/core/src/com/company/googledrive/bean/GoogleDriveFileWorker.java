...
import static com.haulmont.cuba.core.global.FileStorageException.Type.IO_EXCEPTION;
import static com.haulmont.cuba.core.global.FileStorageException.Type.STORAGE_INACCESSIBLE;

/**
 * @author adiatullin
 */
@Component
class GoogleDriveFileWorker {
