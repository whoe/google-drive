...
public class GoogledriveTestContainer extends TestContainer {

    public GoogledriveTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/googledrive/app.properties",
    ...
    public static class Common extends GoogledriveTestContainer {

        public static final GoogledriveTestContainer.Common INSTANCE = new GoogledriveTestContainer.Common();
