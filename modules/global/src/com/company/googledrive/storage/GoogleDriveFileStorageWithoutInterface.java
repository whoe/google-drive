 ...
 * @author adiatullin
 */
public class GoogleDriveFileStorageWithoutInterface {
    private static final Logger log = LoggerFactory.getLogger(GoogleDriveFileStorageWithoutInterface.class);
